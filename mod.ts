 ...
 * comparison.
 *
 * This module provides functions for working with JSON data, or data that comes
 * from JSON-like sources. Its original motivation is to help with inconsistencies
 * that arise when working with data originating as JSON (like API responses) -
 ...
 * @module
 */
export * from "./src/canonicalize.ts";
export * from "./src/compare.ts";
export * from "./src/dedupe.ts";
export * from "./src/parse.ts";
export * from "./src/stringify.ts";
